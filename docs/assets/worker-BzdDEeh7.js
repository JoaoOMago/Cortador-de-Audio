(function () {
  ...
  let n = Error(`unknown message type`),
    ...
    a,
    o = async ({ coreURL: n, wasmURL: r, workerURL: o }) => {
      let s = !a;
      try {
        ((n ||= e), importScripts(n));
      } catch {
        if (
          ((!n || n === e) && (n = e.replace(`/umd/`, `/esm/`)),
      ...
      let c = n,
        l = r || n.replace(/.js$/g, `.wasm`),
        u = o || n.replace(/.js$/g, `.worker.js`);
      return (
    ...
    s = ({ args: e, timeout: t = -1 }) => {
      (a.setTimeout(t), a.exec(...e));
      let n = a.ret;
      return (a.reset(), n);
    },
    c = ({ args: e, timeout: t = -1 }) => {
      (a.setTimeout(t), a.ffprobe(...e));
      let n = a.ret;
      return (a.reset(), n);
    },
    l = ({ path: e, data: t }) => (a.FS.writeFile(e, t), !0),
    u = ({ path: e, encoding: t }) => a.FS.readFile(e, { encoding: t }),
    d = ({ path: e }) => (a.FS.unlink(e), !0),
    f = ({ oldPath: e, newPath: t }) => (a.FS.rename(e, t), !0),
    p = ({ path: e }) => (a.FS.mkdir(e), !0),
    m = ({ path: e }) => {
    ...
    h = ({ path: e }) => (a.FS.rmdir(e), !0),
    g = ({ fsType: e, options: t, mountPoint: n }) => {
      let r = e,
        i = a.FS.filesystems[r];
      return i ? (a.FS.mount(i, t, n), !0) : !1;
    },
    _ = ({ mountPoint: e }) => (a.FS.unmount(e), !0);
  self.onmessage = async ({ data: { id: e, type: i, data: v } }) => {
    ...
    (b instanceof Uint8Array && y.push(b.buffer),
